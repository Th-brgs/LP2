					...
					public void mouseDragged (MouseEvent e) {
						...
						if (Focus != null) {
							...
							if (Focus.clicked(mousex, mousey)) {
								if (Focus.clickNaBorda(posx, posy) == "s") {
									Focus.resizemousecima(dy);
								}
								else {
									if (Focus.clickNaBorda(posx, posy) == "i") {
										Focus.resizemousebaixo(dy);
									}
									else {
										if (Focus.clickNaBorda(posx, posy) == "e") {
											Focus.resizemouseesquerda(dx);
										}
										else {
											if (Focus.clickNaBorda(posx, posy) == "d") {
												Focus.resizemousedireita(dx);
											}
											else {
												if (Focus.clickNaBorda(dx, dy) == "") {
													Focus.dragged(dx, dy);
												}
